...
const Governance: React.FC = () => {
  ...
  const boardMembers = [
    { name: 'Edima Ben Ekpo', role: 'President', tenure: 'Since 2016', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80', color: palette.primary.dark },
